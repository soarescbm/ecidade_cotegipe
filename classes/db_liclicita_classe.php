...
class cl_liclicita {
  ...
  public function sql_query_licitantes($sCampos = null, $sWhere = null) {
    ...
    $sSqlBusca .= "        inner join pcorcamfornelichabilitacao on l17_pcorcamfornelic = pc31_orcamforne"; 
  ...
  function sql_query_propostas($sCampos = null, $sWhere = null, $sGroupBy = null, $sOrderBy = null) {
    ...
    $sSql .= "  inner join pcorcamfornelichabilitacao on l17_pcorcamfornelic = pc31_orcamforne"; 
