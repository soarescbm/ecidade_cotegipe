...
class empenho {
  ...
  function liquidar($numemp = "", $codele = "", $codnota = "", $valor = "", $historico = "", $sHistoricoOrdem = '') {
    ...
    if ($e60_anousu < db_getsession("DB_anousu")) {
      ...
      if (self::ordemDeCompraManual($codnota)) {
        ...
        $lControleLiquidacaoMaterialAlmoxarifado = $oEmpenhoFinanceiro->empenhoRestosPagarPorDocumento(210);
      ...
      if (USE_PCASP) {
        ...
        /**
         * LIQUIDAÇÃO DA PROVISÃO DE FÉRIAS
         */
        ...
        /**
         * LIQUIDAÇÃO DA PROVISÃO DE 13º SALÁRIO
         */
      ...
      /**
       * Caso o empenho não possua controle de despesa em liquidacao e o documento for 204 ou 203, passamos o documento
       * para liquidacao
       */
      $lPossuiControleEmLiqudacao = self::possuiLancamentoDeControle($numemp, $iAnoSessao, array(200, 208, 210));
      if (!$lPossuiControleEmLiqudacao && in_array($codteste, array(202, 204))) {
        $codteste = 3;
      }
    }
    ...
    if ($this->erro_status != '0') {
      ...
      if ($this->anousu == $oEmpenho->e60_anousu) {
        ...
        if (USE_PCASP) {
          ...
          /**
           * Verificamos novamente se é um empenho passivo
           */
          if ($lIsPassivo) {
            $documento = 84;
          }
          ...
          if ($isAmortizacaoDivida) {
            $documento = 506; // LIQUIDAÇÃO AMORT. DÍVIDA
          }

          $isPrecatoria = $oEmpenhoFinanceiro->isPrecatoria();
          if ($isPrecatoria) {
            $documento = 502; // LIQUIDAÇÃO DE PRECATÓRIOS
          }
        }

        $lPossuiDocumento = self::possuiLancamentoDeControle($numemp, $iAnoSessao, array(200, 208, 210, 410));
        if (!$lPossuiDocumento && in_array($documento, array(202, 204))) {
          $documento = 3;
        }
  ...
  function estornaLiq($numemp = "", $codele = "", $codnota = "", $valor = "", $historico = "") {
    ...
    if ($this->anousu == $oEmpenho->e60_anousu) {
      ...
      $aDocumentosControleLiquidacao = array(203, 205);
