    ...
    <td align="center" valign="top" bgcolor="#CCCCCC">
      ...
      <?php
        ...
        if (isset($pc20_codorc) && trim($pc20_codorc) != '') {
          ...
          if (isset($l20_codigo) && trim($l20_codigo) != "") {
            ...
            $res_liclicitemlote = $clliclicitemlote->sql_record(
              $clliclicitemlote->sql_query_licitacao(
                null, "l04_liclicitem", null, "l20_codigo = $l20_codigo and l21_situacao = 0 and l04_descricao = '".@$descricao."'"
              )
            );
          ...
          if (!isset($descricao) && trim(@$descricao) == "" && isset($l20_codigo) && trim($l20_codigo) != "") {
            ...
            $sSqlLote = $clliclicitemlote->sql_query_licitacao(
              null, "l04_liclicitem, l04_descricao", null, "l20_codigo = $l20_codigo and l21_situacao = 0"
            );
          ...
          $sSqlItens = $clpcorcamitem->sql_query_pcmaterlic(
            null,
            "distinct l21_ordem,
            pc81_codprocitem,
            pc81_codproc,
          ...
          if ($numrows_itens > 0) {
            ...
            $oLicitacaoAtributosDinamicos->setCodigoLicitacao(db_utils::fieldsMemory($result_itens, 0)->l20_codigo);

            if ($oLicitacaoAtributosDinamicos->getAtributo('tipoobjeto') == 'OSE') {
              $lLicitacaoTipoObrasServicos = true;
            }

            $aTiposLicitacaoPossuiNotaTecnica = array('MCA', 'MOQ', 'MOT', 'MPP', 'MTC', 'MTO', 'MTT', 'TPR');
            $lPossuiNotaTecnica = in_array($oLicitacaoAtributosDinamicos->getAtributo('tipolicitacao'), $aTiposLicitacaoPossuiNotaTecnica);
      ...
      <tr class='bordas'>
        ...
        <?php
            ...
            if ($ok == true) {
              $result_lancados = $clpcorcamval->sql_record(
                $clpcorcamval->sql_query_file(
                  @$pc21_orcamforne,
                  @$pc22_orcamitem,
            ...
            if (
              isset($pc32_orcamitem)  && trim($pc32_orcamitem) != "" &&
        ...
        <tr class='<?= $class ?>' width='15%'>
          ...
          <td align='center' class='<?= $class ?>' width='15%'>
  	      ...
  	      <td align='left' nowrap class='<?= $class ?>' width='25%' onMouseOver="js_mostra_text(true,'div_text_<?= $pc22_orcamitem ?>', event, this);" onMouseOut="js_mostra_text(false,'div_text_<?= $pc22_orcamitem ?>', event, this);">
            <?= $pc01_descrmater ?>
          </td>
          ...
          <td align='center'  class='<?= $class ?>'>
            <?php db_input("obs_$pc22_orcamitem", 20, $Ipc23_obs, true, 'text', $db_opcao, "onchange='document.form1.vlrun_$pc22_orcamitem.select();' $disabled"); ?>
          </td>
        ...
        <?php } ?>
          ...
          <td align='center'  class='bordas_corp'>
	        ...
	        <td align='center'  class='<?= $class ?>'>
  	        <?php db_input("vlrun_$pc22_orcamitem", 10, $Ipc23_valor, true, 'text', $db_opcao, 'onchange="js_calcvaltot(this.value,\'' . $pc22_orcamitem .'\',this.name); js_passacampo(this.name, \'obs_\' ); js_somavalor();"' . $disabled); ?>
	        </td>

          <td align='center' class='<?= $class ?>' width='15%'>
            <?php db_input("valor_$pc22_orcamitem", 10, $Ipc23_valor, true, 'text', $db_opcao, 'onchange="js_calcvalunit(this.value,\'' . $pc22_orcamitem . '\',this.name);js_passacampo(this.name,\'obs_\');js_somavalor();"' . $disabled); ?>
	        </td>
          ...
          <td align="center" class="<?= $class ?> bordas_corp">
            <?php
              ...
              db_input("notatecnica_$pc22_orcamitem", 7, 4, true, 'text', $db_opcao, 'onchange="js_casasdecimais(this, 2);"' . $disabled);
            ?>
          </td>
          <?php } ?>
          ...
          <td align='center' class='<?= $class ?> bordas_corp'>
            <?php
              ...
              db_input("bdi_$pc22_orcamitem", 7, 4, true, 'text', $db_opcao, 'onchange="js_casasdecimais(this, 2);"' . $disabled);
            ?>
          </td>
            ...
            <?php
              ...
              db_input("encargossociais_$pc22_orcamitem", 10, 4, true, 'text', $db_opcao, 'onchange="js_casasdecimais(this, 2);"' . $disabled);
            ?>
          </td>
          <?php } ?>
        </tr>
        ...
        <?php
          for ($i = 0; $i < $numrows_itens; $i++) :
            db_fieldsmemory($result_itens, $i);
        ?>
          <div id='div_text_<?= $pc22_orcamitem ?>' style="visibility:hidden ; top:0px; left:0px; display:none; background-color:#6699CC ; border:2px outset #ccc">
            <table>
              <tr>
                <td align='left'>
