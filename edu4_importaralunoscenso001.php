...
if (isset($oPost->importar)) {
  ...
  try {
    ...
    if ($oPost->ano_opcao == 2011) {
      ...
      require_once(modification("model/educacao/importacaoAtualizacaoAluno2011.model.php"));
      ...
      require_once(modification("model/educacao/importacaoAtualizacaoAluno2010.model.php"));
    ...
    } elseif ( in_array($oPost->ano_opcao, array(2012, 2013, 2014)) ) {
