...
//        @$data2= "$dt2_ano-$dt2_mes-$dt2_dia";
      ...
      } else if (isset($pc01_codmater) and $pc01_codmater != "") {
      ...
      } else if (isset($z01_numcgm) and $z01_numcgm != "") {
      ...
      } else if (isset($dt1) and $dt1 != "") {

        if (isset($dt2) and $dt2 != "") {
          $sql = $clempautoriza->sql_query(null, $campos, null, "e54_emiss between '$dt1' and '$dt2' {$sWhere}");
        } else {
