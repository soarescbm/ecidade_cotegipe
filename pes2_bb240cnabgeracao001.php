...
$clrotulo->label('rh104_rhgeracaofolha');
...
<table width="790" border="0" cellpadding="0" cellspacing="0" bgcolor="#5786B2">
  ...
  <tr> 
    ...
    <td align="left" nowrap colspan="3">
        <?
          db_input('rh104_rhgeracaofolha',6,$Irh104_rhgeracaofolha,true,'text',1," onchange='js_pesquisarh104_rhgeracaofolha(false);'");
...
function js_pesquisa(mostra){
  if(mostra==true){
    ...
    if(document.form1.rh34_codarq.value != ''){
      ...
      location.href = 'pes2_bb240cnabgeracao001.php';
    }
  }
}
...
function js_mostrarhgeracaofolha1(chave1,chave2){
  document.form1.rh104_rhgeracaofolha.value = chave1;
