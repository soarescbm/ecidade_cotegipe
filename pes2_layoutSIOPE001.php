...
function js_emite(){
  ...
  js_OpenJanelaIframe('top.corpo','db_iframe_geraSIOPE','pes2_layoutSIOPE002.php?'+qry,'Gerando Arquivo',false);
}

function js_erro(msg){
  //js_controlarodape(false);
  top.corpo.db_iframe_geraSIOPE.hide();
  alert(msg);
}
function js_fechaiframe(){
  db_iframe_geraSIOPE.hide();
}
...
//  js_controlarodape(false);
  top.corpo.db_iframe_geraSIOPE.hide();
  listagem = arquivo+"#Download arquivo CSV|";
