...
//  $sSql .= " and m70_codmatmater = 21260 ";
  $sSql .= " {$sOrder}  											                                      ";
...
function contabilizaMateriais($rsMateriais, $dtInicial) {
  ...
  for ($iMaterial = 0; $iMaterial < $iNumeroMateriais; $iMaterial++) {
    ...
    $oItem->nSaldoFinal          = (float) ($oMaterial->saldo_inicial + $oMaterial->entrada - $oMaterial->saida);
 ...
 */
function imprimirPdfGrupos(PDF $oPdf, $iAlturaLinha, $oAgrupamento, $lAnalitica) {
...
function imprimirGrupo($oAgrupamento, $oGrupo, PDF $oPdf, $iAlturaLinha, $lAnalitica,  $lImprimeCabecalho = false) {
...
function imprimirCabecalhoConta(PDF $oPdf, $iAlturaLinha, $oConta, $lPatrimonial = true) {
...
function imprimirRodapeConta(PDF $oPdf, $iAlturaLinha, $oConta, $lAnalitica) {
  ...
  if (!$lAnalitica) {
    ...
    $oPdf->SetFont('arial', '', 6);
    $oPdf->Cell(60, $iAlturaLinha, "", "TBR", 0, "C", 0);
    $oPdf->Cell(30, $iAlturaLinha, "Saldo Inicial", "TBR", 0, "C", 0);
    $oPdf->Cell(25, $iAlturaLinha, "Qtd. Inicial", "TBR", 0, "C", 0);
    $oPdf->Cell(30, $iAlturaLinha, "Entradas", "TBR", 0, "C", 0);
    $oPdf->Cell(25, $iAlturaLinha, "Qtd. Entradas", "TBR", 0, "C", 0);
    $oPdf->Cell(30, $iAlturaLinha, "Saídas", "TBR", 0, "C", 0);
    $oPdf->Cell(25, $iAlturaLinha, "Qtd. Saídas", "TBR", 0, "C", 0);
    $oPdf->Cell(30, $iAlturaLinha, "Saldo final", "TBR", 0, "C", 0);
    $oPdf->Cell(25, $iAlturaLinha, "Qtd. Estoque", "TB", 1, "C", 0);
  }

  $oPdf->SetFont('arial', 'b', 6);
  $oPdf->Cell(60, $iAlturaLinha, "TOTAL", "TB", 0, "R", 1);
  $oPdf->Cell(30, $iAlturaLinha, db_formatar(abs($oConta->nSaldoAnterior), "f"), "LTBR", 0, "R", 1);
  $oPdf->Cell(25, $iAlturaLinha, $oConta->iQuantidadeInicial, "LTBR", 0, "R", 1);
  $oPdf->Cell(30, $iAlturaLinha, db_formatar(abs($oConta->nTotalEntradas), "f"), "LTBR", 0, "R", 1);
  $oPdf->Cell(25, $iAlturaLinha, $oConta->iQuantidadeEntrada, "LTBR", 0, "R", 1);
  $oPdf->Cell(30, $iAlturaLinha, db_formatar(abs($oConta->nTotalSaidas), "f"), "LTBR", 0, "R", 1);
  $oPdf->Cell(25, $iAlturaLinha, $oConta->iQuantidadeSaida, "LTBR", 0, "R", 1);
  ...
  $oPdf->Cell(25, $iAlturaLinha, $oConta->iQuantidadeEmEstoque, "LTB", 1, "R", 1);
}
...
function imprimirCabecalhoItem($oPdf, $iAlturaLinha, $lInicio = false) {
  ...
  if ($oPdf->GetY() > $oPdf->h - 35 || $lInicio) {
    ...
    $oPdf->SetFont('arial', 'b', 6);
    $oPdf->Cell(18, $iAlturaLinha, "Cód. do Material", "TBR", 0, "C", 0);
    $oPdf->Cell(42, $iAlturaLinha, "Nome do Material", "TBR", 0, "C", 0);
    $oPdf->Cell(30, $iAlturaLinha, "Saldo Inicial", "TBR", 0, "C", 0);
    $oPdf->Cell(25, $iAlturaLinha, "Qtd. Inicial", "TBR", 0, "C", 0);
    $oPdf->Cell(30, $iAlturaLinha, "Entradas", "TBR", 0, "C", 0);
    $oPdf->Cell(25, $iAlturaLinha, "Qtd. Entradas", "TBR", 0, "C", 0);
    $oPdf->Cell(30, $iAlturaLinha, "Saídas", "TBR", 0, "C", 0);
    $oPdf->Cell(25, $iAlturaLinha, "Qtd. Saída", "TBR", 0, "C", 0);
    $oPdf->Cell(30, $iAlturaLinha, "Saldo Final", "TBR", 0, "C", 0);
    $oPdf->Cell(25, $iAlturaLinha, "Qtd. Estoque", "TB", 1, "C", 0);
  }
}
...
function imprimirItem($oPdf, $iAlturaLinha,$oItem) {
  ...
  if ( $oItem->iQuantidadeEntrada > 0 ){
    ...
    $oPdf->Cell(18, $iAlturaLinha, $oItem->iCodigo, "TBR", 0, "C", 0);
    $oPdf->Cell(42, $iAlturaLinha, substr($oItem->sDescricao, 0, 30), "TBR", 0, "L", 0);
    $oPdf->Cell(30, $iAlturaLinha, db_formatar(abs($oItem->nSaldoAnterior), "f"), "TBR", 0, "R", 0);
    $oPdf->Cell(25, $iAlturaLinha, abs($oItem->iQuantidadeInicial), "TBR", 0, "R", 0);
    $oPdf->Cell(30, $iAlturaLinha, db_formatar(abs($oItem->nTotalEntradas), "f"), "TBR", 0, "R", 0);
    $oPdf->Cell(25, $iAlturaLinha, $oItem->iQuantidadeEntrada, "TBR", 0, "R", 0);
    $oPdf->Cell(30, $iAlturaLinha, db_formatar(abs($oItem->nTotalSaidas), "f"), "TBR", 0, "R", 0);
    $oPdf->Cell(25, $iAlturaLinha, $oItem->iQuantidadeSaida, "TBR", 0, "R", 0);
    ...
    $oPdf->Cell(25, $iAlturaLinha, $oItem->iQuantidadeEmEstoque, "TB", 1, "R", 0);
  }
}
...
function imprimirTotal($oPdf, $iAlturaLinha, $oTotal) {
  ...
  $oPdf->SetFont('arial', 'b', 6);
  $oPdf->Ln(2);
  $oPdf->Cell(60, $iAlturaLinha, "TOTAL ACUMULADO :", "TBR", 0, "R", 1);
  $oPdf->Cell(30, $iAlturaLinha, db_formatar(abs($oTotal->nSaldoAnterior), "f"), "LTBR", 0, "R", 1);
  $oPdf->Cell(25, $iAlturaLinha, $oTotal->iQuantidadeInicial, "LTBR", 0, "R", 1);
  $oPdf->Cell(30, $iAlturaLinha, db_formatar(abs($oTotal->nTotalEntradas), "f"), "LTBR", 0, "R", 1);
  $oPdf->Cell(25, $iAlturaLinha, $oTotal->iQuantidadeEntrada, "LTBR", 0, "R", 1);
  $oPdf->Cell(30, $iAlturaLinha, db_formatar(abs($oTotal->nTotalSaidas), "f"), "LTBR", 0, "R", 1);
  $oPdf->Cell(25, $iAlturaLinha, $oTotal->iQuantidadeSaida, "LTBR", 0, "R", 1);
  $oPdf->Cell(30, $iAlturaLinha, db_formatar(abs($oTotal->nSaldoFinal), "f"), "LTBR", 0, "R", 1);
  $oPdf->Cell(25, $iAlturaLinha, $oTotal->iQuantidadeEmEstoque, "LTBR", 1, "R", 1);
}
