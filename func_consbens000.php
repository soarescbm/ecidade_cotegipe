      ...
      if(erro == 3){
        ...
        if(botao=="pesquisa"){
          if(x.t52_ident.value!=""){
            js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_func_consbens001','pat1_consbens002.php?t52_ident='+document.form1.t52_ident.value+query,'Pesquisa',true);
          }else if(x.t52_bem.value!=""){
            js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_func_consbens001','pat1_consbens002.php?t52_ident=&t52_bem='+document.form1.t52_bem.value+query,'Pesquisa',true);
          }else if(x.t52_depart.value!=""){
            js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_func_consbensdepart001','func_bens.php?funcao_js=parent.js_mostrabens|t52_bem&chave_depto='+document.form1.t52_depart.value,'Pesquisa',true);
          }
...
<script>
  ...
  function js_pesquisa_bem(mostra){
    if(mostra==true){
      js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_bens','func_bens.php?lConsultaBens=true&opcao=todos&funcao_js=parent.js_mostrabem1|t52_bem|t52_descr','Pesquisa de Bens',true);
    }else{
      if(document.form1.t52_bem.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_bens','func_bens.php?lConsultaBens=true&opcao=todos&pesquisa_chave='+document.form1.t52_bem.value+'&funcao_js=parent.js_mostrabem','Pesquisa de Bens',false);
      }else{
