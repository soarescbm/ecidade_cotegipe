...
DBViewGeracaoAutorizacao = function (sInstancia, oNode, iTipoOrigemDados) {
  ...
  this.calcularSaldoItem = function(oCampo, iItem) {
    ...
    if (nSaldoCampo.valueOf() > nSaldoItem.valueOf()) {
      ...
      alert("Você informou uma quantidade maior que o disponível para o item.");
  ...
  this.visualizarAutorizacao = function () {
    ...
    if ( lConflito ) {
      alert('Em licitações de Chamamento Público / Credenciamento, deve-se selecionar os itens por fornecedor.');
      return false;
    }
