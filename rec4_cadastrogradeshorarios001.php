  ...
  <fieldset>
    ...
    <table align="center">
      ...
      <tr>
        ...
        <td>
          <?php
          db_inputdata('gradehorario_database', null, null, null, true, 'text', 1);
          ?>
        </td>
    ...
    <fieldset>
      <?php
      db_ancora('Jornada', 'js_pesquisaJornada()', 1);
      ?>
...
<script>
  ...
  function js_pesquisarGrade() {
    js_OpenJanelaIframe(
      ...
      'func_gradeshorarios.php?funcao_js=parent.js_retornoPesquisaGrade|rh190_sequencial|rh190_descricao|rh190_database',
      'Pesquisa Grades de Horários',
      true
    );
  }

  function js_retornoPesquisaGrade(iCodigoGrade, sDescricao, dDataBase) {
