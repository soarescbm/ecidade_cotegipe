  ...
  switch ($oParametro->exec) {
    ...
    case "importarArquivo":
      ...
      foreach ($aPeriodos as $oPeriodo) {
        ...
        $oPeriodo->setCodigoArquivo($iCodigoArquivo);
        ...
        ProcessamentoPontoEletronico::processarMatriculas($aMatriculasProcessar, $oPeriodo, $aDatasProcessar);
      }
    ...
    case 'salvarRegistrosPonto':
      ...
      foreach ($oParametro->aDados as $oDados) {
        ...
        $matriculasProcessar[] = $oDados->matricula;
