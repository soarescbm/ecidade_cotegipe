...
$matriz2[3] = round(  ( ( $valor * ( $nm13 - $calc_meses_afas ) ) / $nm13 )   * ( $fracao/ 100) ,2);
        ...
        /***  
          ...
          uemerson@icloud.com
          https://github.com/uemersonsantana
          https://www.linkedin.com/in/uemerson-santana-0a3366117/
          
          Data: 27/03/2018
          Motivo: Não estava dividindo a fração das rubricas auxiliares no adiantamento do 13.
        ***/
        $matriz2[3] = round(  ( ( $valor * ( $nm13 - $calc_meses_afas ) ) / $nm13 )   * ( $fracao_certa/ 100) ,2);
         //---
		   }
		 }
		 $matriz2[4] = 0;
...
//echo "<BR> matriz2[4] = round(  ( ( $quant * ( $nm13 - $calc_meses_afas ) ) / $nm13 )   * ( $fracao/ 100) ,2);";
        ...
        /***  
          ...
          Motivo: Não estava dividindo a fração das rubricas auxiliares no adiantamento do 13.
        ***/
        $matriz2[4] = round(  ( ( $quant * ( $nm13 - $calc_meses_afas ) ) / $nm13 )   * ( $fracao_certa/ 100) ,2);
