  ...
  <tr>
    <td align="center" valign="top">
      ...
      if(!isset($pesquisa_chave)){
	   ...
	   $sql = $cltabrec->sql_query_inst($chave_k02_codigo,$campos,"k02_codigo");
        }else if(isset($chave_k02_descr) && (trim($chave_k02_descr)!="") ){
	   $sql = $cltabrec->sql_query_inst("",$campos,"k02_descr"," upper(k02_descr) like '$chave_k02_descr%' ");
        }else if(isset($chave_k02_drecei) && (trim($chave_k02_drecei)!="") ){
	   $sql = $cltabrec->sql_query_inst("",$campos,"k02_drecei"," upper(k02_drecei) like '$chave_k02_drecei%' ");
        }else if(isset($chave_c61_reduz) && (trim($chave_c61_reduz)!="") ){
	   $sql = $cltabrec->sql_query_inst("",$campos,"k02_drecei"," c61_reduz = $chave_c61_reduz ");
        }else if(isset($chave_o70_codrec) && (trim($chave_o70_codrec)!="") ){
	   $sql = $cltabrec->sql_query_inst("",$campos,"k02_drecei"," o70_codrec = $chave_o70_codrec ");

	}else if(isset($chave_k02_estorc) && (trim($chave_k02_estorc)!="") ){
	   $sql = $cltabrec->sql_query_inst("",$campos,"k02_estorc"," k02_estorc like '$chave_k02_estorc%' ");
