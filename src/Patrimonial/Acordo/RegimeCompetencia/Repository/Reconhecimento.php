...
class Reconhecimento {
  ...
  public static function getReconhecimentosFechados(DBCompetencia $oCompetencia = null, $iCredor, $iContrato) {
    ...
    $sSqlProgramacaoFinanceira = $oProgramacaoFinanceira->sql_query_liquidacao($oCompetencia, $iCredor, $iContrato); 
  ...
  private static function getReconhecimentos ($sWhere) {
    ...
    $campos      = 'ac16_sequencial as acordo, ac16_numero as numero, ac16_anousu as ano, k118_sequencial, k118_ano, k118_mes, sum(k118_valor) as valor';
    $sGroup      = 'ac16_sequencial, ac16_numero, ac16_anousu, k118_sequencial, k118_ano, k118_mes';
