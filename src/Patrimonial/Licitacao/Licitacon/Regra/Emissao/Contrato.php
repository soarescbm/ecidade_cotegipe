...
class Contrato extends BaseAbstract {
  ...
  public function getDadosDaLicitacaoDoContrato($iContrato) {
    ...
    $sSqlAcordo  = $oDaoAcordoItem->sql_query_numero_licitacao($sCampos, null, "ac16_sequencial = {$iContrato} limit 1");
    ...
    if (empty($oDados->numero)) {
      ...
      $sSqlLicitacao = $oDaoAcordoItem->sql_query_numero_licitacao_processo_compras($sCampos, null, "ac16_sequencial = {$iContrato} limit 1");
