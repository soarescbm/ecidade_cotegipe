...
class CobrancaRegistrada
{
  ...
  public static function carregarHeader($iCodigoConvenio)
  {
     ...
     */
    $sCampos     = "ar11_instit, ar13_carteira, ar13_convenio, ar13_cedente, ar13_variacao, ar13_contabancaria, ar13_responsavelnossonumero";
  ...
  public static function registrarReciboWebservice($iNumpreRecibo, $iConvenio, $nValor, $lUsuarioExterno = false)
  {
    ...
    $oRegistro   = $oRepository->getDadosIncluiBoleto($iNumpreRecibo, $iConvenio, $nValor);
