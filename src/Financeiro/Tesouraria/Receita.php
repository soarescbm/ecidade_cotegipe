  ...
  public function getReceitaMulta() {
    ...
    if (!empty($this->dadosReceita->k02_recmul) && empty($this->receitaMulta)) {
      ...
      try {
        ...
        $oRepository        = new \ECidade\Financeiro\Tesouraria\Repository\Receita();
        $oReceitaMulta      = $oRepository->getById($this->dadosReceita->k02_recmul);
  ...
  public function getReceitaJuros() {
    ...
    if (!empty($this->dadosReceita->k02_recjur) && empty($this->receitaJuros)) {
      ...
      try {
        ...
        $oRepository   = new \ECidade\Financeiro\Tesouraria\Repository\Receita();
        $oReceitaJuros = $oRepository->getById($this->dadosReceita->k02_recjur);
