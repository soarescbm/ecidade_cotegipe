  ...
  <tr> 
    ...
    if($numrows_itens > 0) {
      ...
      <tr class='bordas_corp'>
        <td class='bordas_corp' colspan='14' align='center' nowrap ><b> LANÇAR VALORES DOS ORÇAMENTOS </b></td>
      </tr>
      <tr class='bordas'>
      ...
      <?
        for($i=0;$i<$numrows_itens;$i++){
          ...
          if($ok == true){
            ...
            $result_lancados = $clpcorcamval->sql_record($clpcorcamval->sql_query_file(@$pc21_orcamforne,@$pc22_orcamitem,"pc23_quant ,pc23_valor as valor_$pc22_orcamitem,pc23_vlrun as vlrun_$pc22_orcamitem,pc23_obs as obs_$pc22_orcamitem,pc23_validmin  as pc23_validmin_$pc22_orcamitem, pc23_bdi as bdi_$pc22_orcamitem, pc23_encargossociais as encargossociais_$pc22_orcamitem","pc23_orcamitem"));
