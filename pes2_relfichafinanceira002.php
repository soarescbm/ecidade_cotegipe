...
$sql_create_temporary_table.= "                          tabela varchar(15),";
...
foreach ( $aFolhasUtilizadas as $sSigla => $sTabela ) {
  ...
  $sWhereTabelasCalculo  = " fc_anousu_mesusu({$sSigla}_anousu, {$sSigla}_mesusu) between fc_anousu_mesusu($anoi, $mesi) and fc_anousu_mesusu($anof, $mesf) \n";
  ...
  $aSubQueryTabelasCalculo[] = $clrhpessoal->sql_query_baseRelatorios($sTabela, $sSigla, null, null, $iInstituicao, $sCamposTabelasCalculo, $sWhereTabelasCalculo, null, $cadastro_atual);
}
    ...
    $sql_dados_work_ficha_financ = "";
      ...
      for($iiii=0; $iiii<$numrows_dados_work_ficha_financ; $iiii++){
        ...
        if($imprimir_cabecalho_registros == true){
          ...
          $imprimir_cabecalho_rubricas  = true;
          imprimefuncionario_1($novapagina, $oServidor->regist, $oServidor->nomefc, $oServidor->lotaca, $oServidor->dlotac, $oServidor->funcao, $oServidor->dfunca);
        }
        ...
        if($bmes1 > 0 || $bmes2 > 0 || $bmes3 > 0){
           ...
           */
          $aTotaisRub = somarubricasmes($rubric1, $drubri1, $qmes1, $qmes2, $qmes3, $pmes1, $pmes2, $pmes3, $dmes1, $dmes2, $dmes3, $aTotaisRub);
...
function somarubricasmes($rubric1, $drubri1, $qmes1, $qmes2, $qmes3, $pmes1, $pmes2, $pmes3, $dmes1, $dmes2, $dmes3, $aTotais){
