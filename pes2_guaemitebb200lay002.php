...
/* Uemerson Santana */
$consultaBanco = db_query($clrharqbanco->sql_query($rh34_codarq));
db_fieldsmemory($consultaBanco);

$head1 = "BANCO : ".$rh34_descr;
$head2 = "AGÊNCIA : ".$rh34_agencia."-".$rh34_dvagencia;
$head3 = "CONTA : ".$rh34_conta."-".$rh34_dvconta;
/**/
