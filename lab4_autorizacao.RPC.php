    ...
    case 'autorizaExames':
      ...
      foreach ($oParam->aExames as $oExame) {
        ...
        $aWhere          = array(
          ...
          "'{$sDataConvertida}' BETWEEN la56_d_ini AND la56_d_fim",
        ...
        $sSqlBuscaValorItem = $oDaoItemRequisicao->sql_query_requisicao_exames($sCampos, implode(' and ', $aWhere)." group by la56_n_limite, la21_i_setorexame, la08_c_descr");
        */
        ...
        $oDaoItemRequisicao = new cl_lab_requiitem();
        $sSqlBuscaValorItem = $oDaoItemRequisicao->sql_query_requisicao_exames_autorizados($sCampos, implode(' and ', $aWhere)." group by la56_n_limite, la21_i_setorexame, la08_c_descr");
        ...
        if (pg_num_rows($rsBuscaSaldo) == 1) {
          ...
          if ($oStdSaldo->valor_autorizado > $oStdSaldo->limite) {
            ...
            $oErro = (object)array("valor_disponivel" => $nLimiteDisponivel, "valor_autorizado" => $nValorAutorizado, "exame" => $oStdSaldo->descricao_exame);
