  ...
  case "getItensOrigem" :
    ...
    if (isset($_SESSION["oContrato"]) && $_SESSION["oContrato"] instanceof Acordo) {
      ...
      if ($oContrato->getOrigem() == 2) {
        ...
        $aItens = licitacao::getItensPorFornecedor($aLicitacoes, $oContratado->getCodigo(), $lValidaAcordo, true, $aFitros);

      } else {

        $aItens = ProcessoCompras::getItensPorFornecedor($_SESSION["dadosSelecaoAcordo"], $oContratado->getCodigo(), true);
      }
