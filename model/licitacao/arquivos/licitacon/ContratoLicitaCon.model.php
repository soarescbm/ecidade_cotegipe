...
class ContratoLicitaCon extends ArquivoLicitaCon {
  ...
  public function getDados() {
    ...
    $rsContratos     = $this->oRegra->getDadosContrato($this->oCabecalho->getDataGeracao(), $this->oCabecalho->getInstituicao());
  ...
  public function getDiasEventos($iContrato, $oDataVigencia) {
    ...
    $sSqlEventos = $oDaoEventos->sql_query_file(null, 'ac55_acordo, ac55_tipoevento, ac55_data', "ac55_data", $sWhere);
