...
class IntegracaoLicitacao extends IntegracaoBase implements IItemIntegracao {
  ...
  public function carregarDocumentosDaLicitacao() {
    ...
    require_once modification(DB_CLASSES . "classes/db_liclicitaata_classe.php");
    require_once modification(DB_CLASSES . "classes/db_liclicitaedital_classe.php");
    require_once modification(DB_CLASSES . "classes/db_liclicitaminuta_classe.php");
    require_once modification(DB_CLASSES . "classes/db_liclicitaeventodocumento_classe.php");
    require_once modification(DB_CLASSES . "model/licitacao/DocumentoEventoLicitacao.model.php");
