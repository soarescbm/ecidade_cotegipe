...
class licitacao {
  ...
  public function alterarSituacao($iCodigoSituacao, $sObservacao = "", DBDate $oData = null) {
    ...
    if (!in_array($iCodigoSituacao, array(SituacaoLicitacao::SITUACAO_ADJUDICADA, SituacaoLicitacao::SITUACAO_HOMOLOGADA))) {

      $oDaoLiclicitem    = new cl_liclicitem();
      $oDaoOrcreservaSol = new cl_orcreservasol();
      $oDaoOrcreserva    = new cl_orcreserva();

      $sSqlReserva = $oDaoLiclicitem->sql_query_dotacao_reserva(null, "orcreservasol.*", null, "l21_codliclicita = {$this->iCodLicitacao}");
    ...
    if (in_array($iCodigoSituacao, array(SituacaoLicitacao::SITUACAO_ADJUDICADA, SituacaoLicitacao::SITUACAO_HOMOLOGADA))) {
      $oDaolicSituacao->excluir(null, "l11_liclicita = {$this->iCodLicitacao} and l11_licsituacao = {$iCodigoSituacao}");
    }
  ...
  static function getItensPorFornecedor($aLicitacoes, $iFornecedor, $lValidaContrato = true, $lEncode = true, $aOutrosFiltros = array()) {
  ...
  public function getFornecedor() {
    ...
    if (count($this->aFornecedores) == 0 ) {
      ...
      $sSqlBuscaFornecedor        = $oDaoOrcamentoItemLicitacao->sql_query_fornecedores(null, $sCampos, null, $sWhereFornecedor);
