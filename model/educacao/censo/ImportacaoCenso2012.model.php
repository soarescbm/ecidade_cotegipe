...
class ImportacaoCenso2012 extends importacaoCenso {
  ...
  function __construct($sCaminhoArquivo, $iAnoEscolhido, $iCodigoInepEscola = null, $iCodigoLayout) {
    ...
    parent::__construct($sCaminhoArquivo, $iAnoEscolhido, $iCodigoInepEscola, $iCodigoLayout);
  }
  ...
  function getMatriculasRechumano($oLinha) {
    ...
    } else if (isset($oLinha->identificacao_unica_docente) && !empty($oLinha->  identificacao_unica_docente)) {
...
/**
  ...
  function getDadosEscola(DBLayoutLinha $oLinha) {
    ...
    $sSqlEscola = $oDaoEscola->sql_query_file("", "*", "", "ed18_c_codigoinep = '".$oLinha->codigo_escola_inep."'");
  ...
  function atualizaDadosTurma($oLinha, $iAnoCenso) {
    ...
    } elseif ($iTipoAtendimento == 4 || $iTipoAtendimento == 5) {
