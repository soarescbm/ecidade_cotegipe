...
function setHeaderAnalitico($oPdf) {
  ...
  $oPdf->cell(50,  4, "Fabricante",       1, 0, "C", 1);
  $oPdf->cell(30,  4, "Vlr Unitário",     1, 0, "C", 1);
  $oPdf->cell(30,  4, "Qtd Entrada",      1, 0, "C", 1);
  $oPdf->cell(25,  4, "Quant. Atendida",  1, 0, "C", 1);
  $oPdf->cell(20,  4, "Quant. Final",     1, 0, "C", 1);
  $oPdf->cell(25,  4, "Valor",            1, 1, "C", 1);
...
function getDadoAnalitico($oPdf, $oItens, $oTotalEstoqueAnalitico) {
  ...
  $oPdf->cell(50,  4, $oItens->sFabricante,          0, 0, "L", 0);
  $oPdf->cell(30,  4, $nValorUnitario,               0, 0, "R", 0);
  $oPdf->cell(30,  4, $oItens->iQuantidadeEstoque,   0, 0, "R", 0);
  $oPdf->cell(25,  4, $oItens->iQuantidadeAtendida,  0, 0, "R", 0);
  $oPdf->cell(20,  4, ($oItens->iQuantidadeEstoque - $oItens->iQuantidadeAtendida),  0, 0, "R", 0);
  $oPdf->cell(25,  4, $nValorEstoque,                0, 1, "R", 0);
}
