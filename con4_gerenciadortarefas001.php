  ...
  <body class="body-default">
    ...
    <div class="container">
      ...
      <form method="post">
        ...
        <input type="submit" name="iniciar" class="btn-reload" value="Iniciar Serviço" <?php echo $lPermiteInicializacao ? "" : "disbled"; ?> />
...
(function() {
  ...
  oGridTarefas.setHeader(["Tarefas", "Data Criação", "Status", "Lock"]);
  oGridTarefas.setCellWidth(["200", "100", "200", "100"]);
  oGridTarefas.setCellAlign(["left", "center", "center", "center"]);
