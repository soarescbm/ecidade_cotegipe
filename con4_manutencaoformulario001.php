...
<script>
  ...
  (function(exports) {  
     ...
     */ 
    pesquisar = function (iCodigFormulario) {
      ...
      if (janelaCarregada) {
        ...
        pagina = 1
        janelaPesquisa.show();
        pesquisarDados(null, false, pagina, iCodigoFormulario);
        return;
      };     
      ...
      $('btnProximaPagina').observe('click', function(){
        ...
        pesquisarDados($F('filtro'), false, pagina, iCodigoFormulario);
      });
      ...
      pesquisarDados(null, true, pagina, iCodigoFormulario);
    }
     ...
     */
    function pesquisarDados(data, buildGrid, pagina, iCodigoFormulario) {
      ...
      request.send('api/v1/configuracao/formulario/'+iCodigoFormulario, {
        filter: filter,
