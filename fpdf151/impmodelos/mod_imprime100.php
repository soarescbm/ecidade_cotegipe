...
if (empty($this->logo)) {
  ...
  $this->objpdf->SetFont('Arial','',$nFonte);
  $this->objpdf->cell(30,$iAlt,$this->desconto_abatimento      ,'BLR',1,"R");
  $this->objpdf->SetFont('Arial','b',$nFonteLabel);
  ...
  $this->objpdf->cell(50 ,$iAlt, (isset($this->desconto_abatimento) ? $this->desconto_abatimento : ''),'BR' ,1,'L',0);
  ...
  if (isset($this->descr12_1)) {
    ...
    $sInstrucao = substr($sInstrucao,0,250) . "\n";
