    ...
    <td align="center" valign="top"> 
      ...
      $campos = "pc11_codigo as pc11_codigo,
        ...
        if(isset($chave_pc01_codmater) && (trim($chave_pc01_codmater)!="") ){
	         ...
	         $sql = $clpcmater->sql_query_desdobraregistropreco(null,$campos,"pc01_codmater","pc07_codele=$chave_pc07_codele and $where_ativo");
          ...
          if(isset($chave_pc04_codsubgrupo) && trim($chave_pc04_codsubgrupo)!="" && $chave_pc04_codsubgrupo <> 0){
	       ...
	       $sql = $clpcmater->sql_query_desdobraregistropreco("",$campos,"pc01_codmater","pc03_codgrupo = $chave_pc03_codgrupo and pc04_codsubgrupo = pc01_codsubgrupo and pc04_codgrupo = pc03_codgrupo and $where_ativo $where_subgrupo");
        } else {
