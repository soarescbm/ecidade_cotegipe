...
<html lang="pt-br">
  ...
  <body class="<?php echo $sClassAtiva;?>">
    ...
    <div class="container primeiroAcesso">
      ...
      <a href="http://www.softwarepublico.gov.br/ver-comunidade?community_id=15315976" title="Entre na comunidade e-Cidade no Portal do Software P�blico." target="_blank"><img class="logo-ecidade" src="imagens/ecidade/login/logotipo_ecidade.png"/></a>
      ...
      <form method="post" name="form1">
        ...
        <img class="logo-db" style="width: 200px" src="imagens/ecidade/login/logotipo_valle.jpeg">

        <div class="social-midia">
          <p><a href="http://valleteclab.com" target="_blank">valleteclab.com</a><br/>Contato: 77 9 9196 5255</p>
          <!--
          Total Br: Removendo as logo do twitter e do facebook
