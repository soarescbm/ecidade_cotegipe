...
(function () {
  ...
  if ( ($('possui_agenda') && $F('possui_agenda') == "t") || lValidaDataFinal ) {
    ...
    $('sd30_c_horaini').readonly    = "readonly";
    $('sd30_c_horafim').readonly    = "readonly";
    $('sd30_i_fichas').readonly     = "readonly";
    $('sd30_i_reservas').readonly   = "readonly";
    $('sd30_d_valinicial').readonly = "readonly";
    $('sd30_c_tipograde').readonly  = "readonly";
    $('sd30_i_tipoficha').readonly  = "readonly";
    $('sd30_i_undmed').readonly     = "readonly";


    /*
    $('sd30_c_horaini').disabled    = true;
    $('sd30_c_horafim').disabled    = true;
    $('sd30_i_fichas').disabled     = true;
    $('sd30_i_reservas').disabled   = true;
    $('sd30_d_valinicial').disabled = true;
    $('sd30_c_tipograde').disabled  = true;
    $('sd30_i_tipoficha').disabled  = true;
    $('sd30_i_undmed').disabled     = true;
    */
